...
int main( int argc, char **argv ) {
    ...
    for( i = 0; i < nmax*nmax; i++ ) A[i] = (double)rand()/RAND_MAX*2-1;
    for( i = 0; i < nmax*nmax; i++ ) B[i] = (double)rand()/RAND_MAX*2-1;
    for( i = 0; i < nmax*nmax; i++ ) C[i] = (double)rand()/RAND_MAX*2-1;
